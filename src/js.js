...
const _FENGARI_INTEROP_VERSION = FENGARI_INTEROP_VERSION;
export { _FENGARI_INTEROP_VERSION as FENGARI_INTEROP_VERSION };
const _FENGARI_INTEROP_VERSION_NUM = FENGARI_INTEROP_VERSION_NUM;
export { _FENGARI_INTEROP_VERSION_NUM as FENGARI_INTEROP_VERSION_NUM };
const _FENGARI_INTEROP_RELEASE = FENGARI_INTEROP_RELEASE;
export { _FENGARI_INTEROP_RELEASE as FENGARI_INTEROP_RELEASE };
const _checkjs = checkjs;
export { _checkjs as checkjs };
const _testjs = testjs;
export { _testjs as testjs };
const _pushjs = pushjs;
export { _pushjs as pushjs };
const _push = push;
export { _push as push };
const _tojs = tojs;
export { _tojs as tojs };
const _luaopen_js = luaopen_js;
export { _luaopen_js as luaopen_js };
